...
-- Fri 17 Jan 2020 07:09:29 PM CET
...
CREATE TABLE IF NOT EXISTS `mydb`.`Korisnik` (
  ...
  INDEX `fk_Korisnik_Uloga1_idx` (`Uloga_idUloga` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Rezervacija` (
  ...
  INDEX `fk_Rezervacija_Dom1_idx` (`Dom_idDom` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Izvestaj` (
  ...
  INDEX `fk_Izvestaj_Rezervacija1_idx` (`Rezervacija_idRezervacija` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Planinarska_staza` (
  ...
  `Planina_idPlanina` INT NOT NULL,
  PRIMARY KEY (`idStaza`),
  INDEX `fk_Planinarska_staza_Planina1_idx` (`Planina_idPlanina` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Znamenitost` (
  ...
  INDEX `fk_Znamenitost_Planinarska_staza1_idx` (`Planinarska_staza_idStaza` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Poseta` (
  ...
  INDEX `fk_Poseta_Termin1_idx` (`Termin_idTermin` ASC)  ,
  INDEX `fk_Poseta_Rezervacija1_idx` (`Rezervacija_idRezervacija` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Komentar` (
  ...
  INDEX `fk_Komentar_Poseta1_idx` (`Poseta_idPoseta` ASC)  ,
